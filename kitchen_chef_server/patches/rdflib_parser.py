...
from pyparsing import ParserElement, ParseResults, TokenConverter, originalTextFor, re
    ...
    def postParse(
        ...
        if self.evalfn:
            ...
            if self.name == "ServiceGraphPattern":
                ...
                found_services = sgp.searchString(instring)
                for found_service in found_services:
                    service_string = found_service[0]
                    ...
                    res[match.group(1)] = service_string
